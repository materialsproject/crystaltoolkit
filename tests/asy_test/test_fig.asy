...
triple sphere2=(0.8050000001609999, -0.46476696679060214, 0.0);

triple sphere3=(-0.8050000001609999, 0.46476696679060203, 2.62);


triple[] spheres = {sphere1,sphere2,sphere3};
drawSpheres(spheres, 0.5, rgb('c28f8f'));
