...
html_theme_options = {
    "canonical_url": "https://crystaltoolkit.org",
    "logo_only": True,
    "display_version": True,
    "prev_next_buttons_location": None,
    "style_external_links": True,
    "style_nav_header_background": "linear-gradient(0deg, rgba(23,162,135,1) 0%, rgba(0,192,136,1) 100%)",
